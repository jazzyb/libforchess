...
INCLUDES=-I./src
TEST_FILES=test/check_forchess.c test/check_moves.c test/check_board.c test/check_check.c test/check_ai.c test/check_game.c
INC_FILES=src/forchess/moves.h src/forchess/board.h src/forchess/ai.h src/forchess/game.h
SRC_FILES=src/ai.c src/board.c src/check.c src/moves.c src/game.c
